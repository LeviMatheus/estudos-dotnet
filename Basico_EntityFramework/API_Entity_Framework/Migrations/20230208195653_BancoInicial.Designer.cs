...
namespace Comercio.API.Migrations
{
    ...
    [Migration("20230208195653_BancoInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Comercio.Models.Contato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Comercio.Models.Departamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Comercio.Models.EnderecoEntrega", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Comercio.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Comercio.Models.Contato", b =>
                {
                    b.HasOne("Comercio.Models.Usuario", "Usuario")
                        .WithOne("Contato")
                        .HasForeignKey("Comercio.Models.Contato", "UsuarioId")
            ...
            modelBuilder.Entity("DepartamentoUsuario", b =>
                {
                    b.HasOne("Comercio.Models.Departamento", null)
                        .WithMany()
                        .HasForeignKey("DepartamentosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Comercio.Models.Usuario", null)
                        .WithMany()
